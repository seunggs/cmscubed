(function () {
  ...
  /**
   * @ngdoc service
   * @name common.factory:C3CoreService
   *
   * @description
   *
   */
  angular
    .module('common')
    .factory('C3CoreService', C3CoreService);

  function C3CoreService(R) {
    
    let C3CoreServiceBase = {};
    ...
    // setC3RepeatAttribute :: Element -> Element
